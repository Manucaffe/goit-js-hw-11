...
var _gallerySetup = require("./js/gallery-setup");
var _getImages = require("./js/get-images");
var _scrollSetup = require("./js/scroll-setup");
...
async function fetchImages() {
    try {
        const { data  } = await (0, _getImages.getImages)(query, page, perPage);
...
function handleFetchResults(data) {
    ...
    (0, _gallerySetup.gallerySetup)(data.hits);
...
},{"notiflix":"fuMq1","simplelightbox":"9ydBq","./js/gallery-setup":"iXO7y","./js/get-images":"cxlg4","./js/scroll-setup":"9Dkwl","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fuMq1":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"iXO7y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "gallerySetup", ()=>gallerySetup);
const gallery = document.querySelector(".gallery");
...
},{}],"cxlg4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _axiosDefault.default).defaults.baseURL = API_URL;
...
const composeSignals = (signals, timeout)=>{
    ...
    signal1.unsubscribe = unsubscribe;
    return [
        signal1,
        ()=>{
            timer && clearTimeout(timer);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Dkwl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function onScroll() {
    ...
    if (scrolled > coords) console.log("Scrolled past viewport height");
    else console.log("Within viewport height");
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kaxSc":[function() {},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
